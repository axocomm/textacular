...
\begin{slide}{Implementation}
  \twocolumn{
    ...
    \vspace{-40px}
    \begin{figure}
      \caption{View after generating an invoice}
    ...
    \begin{itemize}
      ...
      \item A \texttt{TeXHandler} class handles compilation of \TeX\
        source
        \begin{itemize}
          \item Uses \texttt{latexmk} and a script (\texttt{res/bin/compile})
            to compile
        \end{itemize}
...
\begin{slide}{Notes}
  \twocolumn{
    ...
    \begin{itemize}
      ...
      \item Add options dialogue for font/package selection and paper size
    \end{itemize}
  }
\end{slide}
\end{document}
